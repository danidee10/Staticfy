...
# protect against externally links like Google fonts, FontAwesome etc
links = html_doc.find_all(lambda x: True if x.name == 'link' and 'http' not in x.get('href') else False)
